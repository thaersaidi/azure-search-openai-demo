...
def test_home(page: Page, live_server_url: str):
    ...
    expect(page).to_have_title("Crayon + Azure AI")
...
def test_chat(sized_page: Page, live_server_url: str):
    ...
    page.get_by_placeholder("Type a new question (e.g. tell me about my x document..?)").click()
    page.get_by_placeholder("Type a new question (e.g. tell me about my x document..?)").fill(
